<?php
    while($row = mysqli_fetch_assoc($query)){
        ...
        (mysqli_num_rows($query2) > 0) ? $result = $row2['msg'] : $result ="Aguardando Suporte . . .";
        ...
        $output .= '<div class="content">
                    ...
                    <div><a href="chat.php?user_id='. $row['unique_id'] .'"><button class="btn-aten">Atender</button></a></div>';
    }
?>