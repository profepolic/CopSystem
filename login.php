...
<img src="src/images/login/login.png" alt="">
    <div class="col-lg-5 bodyc">
            <div class="card card-info">
                ...
                <h3>Login</h3>
              <form class="form-horizontal" action="kernel/login.php" method="POST">
                <div class="card-body">
                  <div class="form-group row">
                    <img src="src/images/login/login3.png" alt="">
                    <div class="col-sm-10">
                      <input type="text" name="usuario" class="form-control login" id="inputEmail3" placeholder="Nick">
                    </div>
                  </div>
                  <div class="form-group row">
                    <img src="src/images/login/login4.png" alt="">
                    <div class="col-sm-10">
                      <input type="password" name="senha" class="form-control login" id="inputPassword3" placeholder="Senha">
                    </div>
                  </div><br>
                  <div class="row">
                ...
                <div class="card-footer">
                  ...
                  <p>Não tem uma conta? <a class="Linklogin" href="index_registrar">Clique aqui!!!</a></p>
                </div>
              </form>
            </div>
    </div>
